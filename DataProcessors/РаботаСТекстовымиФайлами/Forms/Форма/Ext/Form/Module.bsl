...
Процедура ПрочитатьФайлПолностью(Команда)
	...
	ТекстовыйДокумент.НачатьЧтение(Новый ОписаниеОповещения("ПрочитатьФайлПолностьюЗавершение", ЭтотОбъект, ТекстовыйДокумент), ИмяФайла);
	
КонецПроцедуры

&НаКлиенте
Процедура ПрочитатьФайлПолностьюЗавершение(ТекстовыйДокумент) Экспорт
